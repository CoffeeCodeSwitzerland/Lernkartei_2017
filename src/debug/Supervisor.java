...
public class Supervisor {
	 ...
	 *  ==================================================================
	 *  - erzeugen eines Log's und abspeicher in Datei (neu anlegen oder überschreiben möglich)
	 *  - debug Meldungen mit Ein- und Ausschaltmöglichkeit
	 *  - situativ einstellbare Reaktionen auf Warungen, Fehler und Exception
	 *  - Umsetzung des "Raketenprinzips" (TODO: unabh. Überwachungsthread für Fehlerzustände)
	 */
	...
	public static void setSupervisorShowState(int supervisorShowState) {
		if (supervisorShowState > 4) supervisorShowState = 4;
		if (supervisorShowState < 0) supervisorShowState = 0;
		Supervisor.supervisorShowState = supervisorShowState;
	}
	public static void setSupervisorExitState(int supervisorExitState) {
		if (supervisorExitState > 4) supervisorExitState = 4;
		if (supervisorExitState < 0) supervisorExitState = 0;
