...
public abstract class Functions
{
	...
	public static String realBbCode2HTML (String input, String... tags)
	{
		if (tags.length % 2 != 0)
		{
			debug.Debugger.out("real BBCode 2 HTML : The cout of tag arguments has to be even");
			return null;
		}
	...
	public static void openWebpage (String urlString)
	{
		...
		catch (Exception e)
		{
			...
			Logger.out("Functions.openWebpage(" + urlString + "): please set a browser as standard!");
			e.printStackTrace();
		}
	}
