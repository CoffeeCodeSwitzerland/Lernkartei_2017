...
/*
 * 
 * Erklärung der Passwort verschlüsseln
 * 
 * Das abgespeicherte Passwort ist ein hash mit einem zufällig generierten Salz. 
 * Diesen String hashen wir mit PBKDF2
 * 
 * Diese Klasse habe ich kopiert 
 * Quelle : https://github.com/defuse/password-hashing/blob/master/PasswordStorage.java
 * 
 */
...
public abstract class Security
{
	...
	public static String createHash(char[] password, byte[] salt) throws CannotPerformOperationException
	{
