...
public class ImportCSV {
	...
	public ImportCSV(List<String[]> list) {

		csvTable = new Table(Tbl_Name);

		for (int i = 0; i < list.get(0).length; i++) {

			eingabe = JOptionPane.showInputDialog("Enter Attribute:");
			Attributes attr = new Attributes(eingabe, "TEXT", true);
