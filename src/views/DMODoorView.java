...
public class DMODoorView extends FXView
{
	...
	public Parent constructContainer()
	{
		...
		try {
			...
			Debugger.out("DMODoorView-constructContainer: did not found a Model named 'serverstack'!");
		}		
		return bp;
	}
	...
	public void refreshView()
	{
		...
		for(int i = 0; i < dataLength; i++)
		{
			...
			btnModify.setOnAction(e ->
			{
				...
				getFXController().showAndTrackView("dmomodifydoorview");
			});
			
			btnServerDoor.setOnAction(e -> getFXController().showAndTrackView("dmostackview"));
